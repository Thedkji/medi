                ...
                <div id="logo" class="flex-col logo">
                    ...
                    <div class="flex-col hide-for-medium flex-right">
                        <ul class="desktop-nav header-nav header-nav-main nav nav-right  nav-pills nav-size-large nav-uppercase">
                            ...
                            <li id="menu-item-904" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-904 menu-item-design-default has-dropdown"><a href="<?= $url ?>?page=feature" class="nav-top-link" aria-expanded="false" aria-haspopup="menu">Tính năng<i class="icon-angle-down"></i></a></li>
